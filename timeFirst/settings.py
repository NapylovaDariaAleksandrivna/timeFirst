"""
Django settings for timeFirst project.
...
SECRET_KEY = 'django-insecure-n#p68=olh4y^jst%&5pl+y81p@d^!!as@p&ac!q=p$-p9ws!=j'
...
WSGI_APPLICATION = 'timeFirst.wsgi.application'
